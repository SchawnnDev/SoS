...
instructions : id ASSIGN final_concatenation {log_debug("instructions: (%s, %s, %s)", $1,$2,$3); assign($1, $3, 0); if(HAS_ERROR()) YYABORT ; }
    ...
    | IF test_block marker_then THEN list_instructions marker_end_instruction else_part FI { doMarkerFi(); if(HAS_ERROR()) YYABORT ; }
...
marker_then : {$$ = ""; doMarkerThen(); if(HAS_ERROR()) YYABORT ; }
